...
> 在大模型网页端问了一堆问题，问完就忘光了。AI 的知识一点都没有变成我的知识。<br>
> 正好又想深度体验一下 vibecoding，于是做了这个小玩具。<br>
> 简单来说：**多轮对话 → 自动生成知识图谱可随时检索 → 顺便生成复习资料帮你真正记住。**
>
> ——当然，实话说花钱调用 API 做复习卡片的性价比堪忧（笑）


如果把场景放大一点，可以是：

> 团队内部使用，自动总结大家常问的问题，指导开会讨论和方向决策；成员之间也可以互相分享心得体会。
